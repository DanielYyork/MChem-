...
"""
Function imported from ramdom_smiles_generation.py
"""
...
def randomSmiles(m1):
    ...
    for i in range(1000):
        ...
        for i,v in enumerate(idxs):
            ...
            m1_smiles = Chem.MolToSmiles(m1)
            s.add(m1_smiles)
    return s

"""
Functions imported from smiles2stereoisomers.py
"""
from rdkit import Chem
from rdkit.Chem.Draw import IPythonConsole
from rdkit.Chem import Draw
...
def GetStereoIsomers(mol):
    ...
    if chiralCentres == []:
        ...
        for isoId,element in enumerate(elements):       
            ...
            out_smiles.add(Chem.MolToSmiles(mol,isomericSmiles=True))
            #print (Chem.MolToSmiles(mol,isomericSmiles=True))
        return out_smiles
